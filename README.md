...
### Temporal
MAAS Site Manager requires Temporal. To deploy it, follow the instructions below.
...
juju deploy temporal-k8s --config num-history-shards=4 --config external-hostname=temporal
