/* eslint-disable */
// @ts-nocheck
// based on https://github.com/maplibre/maplibre-gl-js/blob/main/test/unit/lib/web_worker_mock.ts

import { WorkerGlobalScopeInterface } from "maplibre-gl/src/util/web_worker";
import { ActorTarget } from "maplibre-gl/src/util/actor";
